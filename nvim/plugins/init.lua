return {
  ...
  },
  {
    ...
    event = "BufEnter",
    config = function()
      -- Disable default bindings for Codeium
      vim.g.codeium_disable_bindings = 1

      -- Set keymaps for Codeium functionality
      vim.keymap.set('i', '<M-g>', function() return vim.fn['codeium#Accept']() end, { expr = true, silent = true })
      vim.keymap.set('i', '<M-m>', function() return vim.fn['codeium#CycleCompletions'](1) end, { expr = true, silent = true })
